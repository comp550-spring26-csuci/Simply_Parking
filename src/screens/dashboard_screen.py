...
def build_dashboard_screen(app):
    ...
    if role == "admin":
        ...
        add_nav_button(nav, "Buy Permit", app.show_buy_permit_choice)
        add_nav_button(nav, "My Permits", app.show_my_permits)
        ...
        add_nav_button(nav, "Pay On Exit", app.show_pay_exit)
        add_nav_button(nav, "Report Issue", app.show_report_issue)
        add_nav_button(nav, "Create Account", app.show_register_account)
